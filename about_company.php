...
<main>
    <section class="section-1">
        <div class="container">
            <div>
                <div class="text_big">
                    <p class="text_size-48">
                        Производство и продажа изделий из графита
                    </p>
                    <p class="text text_size-20">
    ...
    <section class="section-2">
        <div class="container">
            <div>
                <p class="text text_size-36">Наша <span class="text_big">продукция</span></p>
                <img class="line" src="image/right_line.png"/>
            </div>
            <div class="row text_big text_size-20">
                <a class="col" href="/"><div class="col img-1"><div>Графит мелкий</div></div></a>
                <a class="col" href="/"><div class="col img-2"><div>Графит конструкционный</div></div></a>
                <a class="col" href="/"><div class="col img-3"><div>Науглероживатель</div></div></a>
                <a class="col" href="/"><div class="col img-4"><div>Графит карандашный ГК. Тип кристаллический</div></div></a>
                <a class="col" href="/"><div class="col img-5"><div>Бой графита</div></div></a>
                <a class="col" href="/"><div class="col img-6"><div>МГ - Графиты малозольные</div></div></a>
                <a class="col" href="/"><div class="col img-7"><div>Углепластики</div></div></a>
                <a class="col" href="/"><div class="col img-8"><div>Смазочные графитовые стержни</div></div></a>
                <a class="col" href="/"><div class="col img-9"><div>Лопатки из графита</div></div></a>
            </div>
        </div>
    </section>
    <section class="section-3">
        <div class="container">
            <div>
                <p class="text text_size-36">Наши <span class="text_big">приемущества</span></p>
                <img class="line" src="image/right_line.png"/>
            </div>
            <div class="row text_big text_size-20">
                <div class="col"><img src="/image/icon1.png"/><div>Более 20 лет на рынке</div></div>
                <div class="col"><img src="/image/icon2.png"/><div>Высокое качество продукции</div></div>
                <div class="col"><img src="/image/icon3.png"/><div>300+ тн отгрузок в месяц</div></div>
    ...
    <section class="section-4">
        <div class="container">
            <div>
                <p class="text text_size-36">Нам доверяют <span class="text_big">лучшие</span></p>
                <img class="line" src="image/right_line.png"/>
            </div>
            <div class="slider">
    ...
    <section class="section-5">
        ...
        <div class="container">  
            <div class="form text">
                <div>
                    <div>
                        <p class="text text_size-36">Контакты</p>
                        <img class="line" src="image/right_line.png"/>
                    </div>
                    <div class="info">
                        <div>
